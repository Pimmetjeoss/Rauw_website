    ...
    <>
      ...
      <div className="absolute left-0 right-0 top-[70vh] mt-4 z-20 pl-0 pr-0">
        <p className="text-white" style={{
          ...
          Onze exclusieve collectie handgemaakte tafels, vakkundig vervaardigd in Nederland uit duurzame, hoogwaardige materialen. Ontworpen voor zowel duurzaamheid als stijl, bieden deze tafels de perfecte oplossing om uw woonruimte te verrijken, karakter te geven en jarenlang van kwaliteit te genieten.
        </p>
      </div>
      ...
      <div className="absolute left-0 top-[8vh] w-[40%] z-20">
        ...
        <p className="text-white text-sm" style={{
          ...
          Ontdek onze met de hand vervaardigde, Nederlands gemaakte tafels, ontworpen met hoogwaardige materialen om uw interieur uniek te maken.
        </p>
      </div>
